...
curl -L ftp://bsp.hedonline.com/HELDK-4/gcc-hed-linux-gnueabihf_1.0.0_linux-3.14_cortex-a7.tar.xz -o toolchain.tar.xz
tar xzf toolchain.tar.xz
mv arm-hed-linux-gnueabihf tools

CROSSTOOL_CC=${TOOLCHAIN_INSTALL_PATH}/tools/bin/arm-rpi-linux-gnueabihf/bin/arm-hed-linux-gnueabihf-gcc
